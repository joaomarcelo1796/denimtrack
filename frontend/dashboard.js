...
async function carregarProcessos() {
    try {
        const resposta = await fetch("http://denimtrack.com.br:3000/processos");
...
async function avancarEtapa(id) {
    try {
        const resposta = await fetch(`http://denimtrack.com.br:3000/processos/${id}`, { method: "PUT" });
...
async function excluirProcesso(id) {
    ...
    try {
        const resposta = await fetch(`http://denimtrack.com.br:3000/processos/${id}`, { method: "DELETE" });
...
async function editarProcesso(id, statusAtual) {
    ...
    try {
        const resposta = await fetch(`http://denimtrack.com.br:3000/processos/${id}/editar`, {
            method: "PUT",
